...
{
    public class DatabaseUtils : DatabaseConnection
    {
        public DatabaseUtils(NameValueCollection appSettings) : base(appSettings)
        {
        }

        public DatabaseUtils(string server, string database, bool isTrusted, string login = null,
